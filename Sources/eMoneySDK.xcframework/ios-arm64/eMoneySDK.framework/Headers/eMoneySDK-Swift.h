...
#ifndef EMONEYSDK_SWIFT_H
#define EMONEYSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="eMoneySDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9eMoneySDK17AOModalStatusView")
@interface AOModalStatusView : UIView
...
SWIFT_CLASS("_TtC9eMoneySDK23AdvancedPageControlView")
...
SWIFT_PROTOCOL("_TtP9eMoneySDK10AnchorView_")
@protocol AnchorView
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9eMoneySDK10BaseButton")
...
SWIFT_CLASS("_TtC9eMoneySDK13BaseInputView")
@interface BaseInputView : UIView <UITextInput>
...
@interface BaseInputView (SWIFT_EXTENSION(eMoneySDK)) <UITextInputTokenizer>
- (UITextRange * _Nullable)rangeEnclosingPosition:(UITextPosition * _Nonnull)position withGranularity:(UITextGranularity)granularity inDirection:(UITextDirection)direction SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isPosition:(UITextPosition * _Nonnull)position atBoundary:(UITextGranularity)granularity inDirection:(UITextDirection)direction SWIFT_WARN_UNUSED_RESULT;
- (UITextPosition * _Nullable)positionFromPosition:(UITextPosition * _Nonnull)position toBoundary:(UITextGranularity)granularity inDirection:(UITextDirection)direction SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isPosition:(UITextPosition * _Nonnull)position withinTextUnit:(UITextGranularity)granularity inDirection:(UITextDirection)direction SWIFT_WARN_UNUSED_RESULT;
@end

@class NSBundle;

SWIFT_CLASS("_TtC9eMoneySDK18BaseViewController")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9eMoneySDK22BetterSegmentedControl")
...
@property (nonatomic) IBInspectable CGFloat cornerRadiusSegment;
...
@interface BetterSegmentedControl (SWIFT_EXTENSION(eMoneySDK))
@end

@class UIGestureRecognizer;

@interface BetterSegmentedControl (SWIFT_EXTENSION(eMoneySDK)) <UIGestureRecognizerDelegate>
...
@interface BetterSegmentedControl (SWIFT_EXTENSION(eMoneySDK)) <UIPointerInteractionDelegate>
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9eMoneySDK12CustomSwitch")
...
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull offTintColor;
...
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull thumbShadowColor;
@property (nonatomic) IBInspectable CGSize thumbShadowOffset;
@property (nonatomic) IBInspectable CGFloat thumbShaddowRadius;
@property (nonatomic) IBInspectable float thumbShaddowOppacity;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC9eMoneySDK15CustomThumbView")
...
@interface CustomThumbView (SWIFT_EXTENSION(eMoneySDK))
- (void)layoutSubviews;
@end


SWIFT_CLASS("_TtC9eMoneySDK14DefaultPinView")
@interface DefaultPinView : UIView
- (void)awakeFromNib;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9eMoneySDK23DefaultTextFieldAdapter")
@interface DefaultTextFieldAdapter : NSObject
...
SWIFT_CLASS("_TtC9eMoneySDK8DropDown")
...
@interface DropDown (SWIFT_EXTENSION(eMoneySDK))
...
@interface DropDown (SWIFT_EXTENSION(eMoneySDK)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC9eMoneySDK12DropDownCell")
...
@interface DropDownCell (SWIFT_EXTENSION(eMoneySDK))
- (void)awakeFromNib;
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9eMoneySDK13FSPageControl")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9eMoneySDK11FSPagerView")
...
@interface FSPagerView (SWIFT_EXTENSION(eMoneySDK))
@end
...
SWIFT_CLASS("_TtC9eMoneySDK15FSPagerViewCell")
...
SWIFT_PROTOCOL("_TtP9eMoneySDK21FSPagerViewDataSource_")
...
SWIFT_PROTOCOL("_TtP9eMoneySDK19FSPagerViewDelegate_")
...
SWIFT_CLASS("_TtC9eMoneySDK27FSPagerViewLayoutAttributes")
...
SWIFT_CLASS("_TtC9eMoneySDK22FSPagerViewTransformer")
...
SWIFT_PROTOCOL("_TtP9eMoneySDK28FloatingPanelLayoutAnchoring_")
...
SWIFT_CLASS("_TtC9eMoneySDK33FloatingPanelAdaptiveLayoutAnchor")
...
@interface FloatingPanelAdaptiveLayoutAnchor (SWIFT_EXTENSION(eMoneySDK))
...
SWIFT_PROTOCOL("_TtP9eMoneySDK21FloatingPanelBehavior_")
...
SWIFT_PROTOCOL("_TtP9eMoneySDK19FloatingPanelLayout_")
...
SWIFT_CLASS("_TtC9eMoneySDK25FloatingPanelBottomLayout")
...
SWIFT_CLASS("_TtC9eMoneySDK23FloatingPanelController")
...
SWIFT_PROTOCOL("_TtP9eMoneySDK31FloatingPanelControllerDelegate_")
@protocol FloatingPanelControllerDelegate
@optional
...
SWIFT_CLASS("_TtC9eMoneySDK34FloatingPanelIntrinsicLayoutAnchor")
...
@interface FloatingPanelIntrinsicLayoutAnchor (SWIFT_EXTENSION(eMoneySDK))
- (NSArray<NSLayoutConstraint *> * _Nonnull)layoutConstraints:(FloatingPanelController * _Nonnull)vc for:(enum FloatingPanelPosition)position SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC9eMoneySDK25FloatingPanelLayoutAnchor")
...
@interface FloatingPanelLayoutAnchor (SWIFT_EXTENSION(eMoneySDK))
- (NSArray<NSLayoutConstraint *> * _Nonnull)layoutConstraints:(FloatingPanelController * _Nonnull)vc for:(enum FloatingPanelPosition)position SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC9eMoneySDK33FloatingPanelPanGestureRecognizer")
...
SWIFT_CLASS("_TtC9eMoneySDK18FloatingPanelState")
...
SWIFT_CLASS("_TtC9eMoneySDK24FloatingSegmentedControl")
@interface FloatingSegmentedControl : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)awakeFromNib;
@property (nonatomic, readonly) CGSize intrinsicContentSize;
...
SWIFT_CLASS("_TtC9eMoneySDK15IQBarButtonItem") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC9eMoneySDK28IQBarButtonItemConfiguration") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC9eMoneySDK12IQInvocation") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC9eMoneySDK17IQKeyboardManager") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
@interface IQKeyboardManager (SWIFT_EXTENSION(eMoneySDK)) <UIGestureRecognizerDelegate>
...
SWIFT_CLASS("_TtC9eMoneySDK26IQKeyboardReturnKeyHandler") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(eMoneySDK)) <UITextFieldDelegate>
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(eMoneySDK)) <UITextViewDelegate>
...
SWIFT_CLASS("_TtC9eMoneySDK18IQPreviousNextView") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC9eMoneySDK10IQTextView") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC9eMoneySDK20IQTitleBarButtonItem") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC9eMoneySDK9IQToolbar") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC9eMoneySDK37InternetConnectionErrorViewController")
@interface InternetConnectionErrorViewController : BaseViewController
- (nonnull instancetype)init;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC9eMoneySDK19LoginViewController")
...
SWIFT_CLASS("_TtC9eMoneySDK23NVActivityIndicatorView")
...
SWIFT_CLASS("_TtC9eMoneySDK12OTPTextField")
@interface OTPTextField : BaseInputView
...
- (BOOL)resignFirstResponder;
@property (nonatomic, readonly) BOOL hasText;
- (void)insertText:(NSString * _Nonnull)character;
- (void)deleteBackward;
...
SWIFT_CLASS("_TtC9eMoneySDK24OnboardingViewController")
@interface OnboardingViewController : UIViewController
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animdated;
- (void)viewWillAppear:(BOOL)animated;
...
SWIFT_CLASS("_TtC9eMoneySDK20SplashViewController")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9eMoneySDK11TagListView")
...
SWIFT_PROTOCOL("_TtP9eMoneySDK19TagListViewDelegate_")
@protocol TagListViewDelegate
@optional
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9eMoneySDK7TagView")
...
SWIFT_CLASS("_TtC9eMoneySDK9ToolTipVC")
@interface ToolTipVC : UIViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface ToolTipVC (SWIFT_EXTENSION(eMoneySDK)) <UIPopoverPresentationControllerDelegate>
...
@interface UIBarButtonItem (SWIFT_EXTENSION(eMoneySDK)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIScrollView (SWIFT_EXTENSION(eMoneySDK))
...
@interface UIView (SWIFT_EXTENSION(eMoneySDK)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIView (SWIFT_EXTENSION(eMoneySDK))
/// To set customized distance from keyboard for textField/textView. Can’t be less than zero
@property (nonatomic) CGFloat keyboardDistanceFromTextField;
...
@interface UIViewController (SWIFT_EXTENSION(eMoneySDK))
